...
function Command({
  ...
  return (
    <CommandPrimitive
      data-slot="command"
      className={cn(
        "bg-light dark:bg-muted text-accent-foreground flex size-full flex-col overflow-hidden rounded-md",
        className
      )}
      {...props}
    />
...
function CommandInput({
  ...
  return (
    <div
      className="border-border/70 flex items-center border-b px-5"
      cmdk-input-wrapper=""
    >
...
function CommandItem({
  ...
  return (
    <CommandPrimitive.Item
      ...
      className={cn(
        "data-[selected=true]:bg-primary/5 data-[selected=true]:text-primary relative flex cursor-default items-center gap-3 rounded-md px-2 py-1.5 text-sm outline-none select-none data-[disabled=true]:pointer-events-none data-[disabled=true]:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0",
        className
      )}
      {...props}
    />
